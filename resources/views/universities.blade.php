    ...
    <nav class="sticky top-0 z-50 bg-white/80 dark:bg-[#0a0f1c]/80 backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-800/50 shadow-sm transition-all duration-300">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-reverse space-x-1 bg-gray-100/50 dark:bg-gray-800/50 p-1 rounded-2xl border border-gray-200/50 dark:border-gray-700/50">
                ...
                <!-- زانکۆکان چالاککراوە (Active) -->
                <a href="/universities" class="px-4 py-2 bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 font-bold rounded-xl shadow-sm transition lang-str" data-so="زانکۆکان" data-ba="زانکۆ">زانکۆکان</a>
            </div>
...
<<<<<<< HEAD
    ...
    <a href="/universities" class="px-3.5 py-2 bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 font-bold rounded-xl shadow-sm transition text-sm lang-str" data-so="زانکۆکان" data-ba="زانکۆ">زانکۆکان</a>
...
>>>>>>> df4ede4228ca553f4dfb5739740a489a0b79faa2
    ...
    <!-- بەشی پیشاندانی زانکۆکان -->
    <section class="relative z-10 container mx-auto pb-24 px-4">
        <div id="uni-container" class="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto"></div>
    </section>
    ...
    <script type="module">
        ...
        function renderUniversities() {
            ...
            if (Object.keys(unisData).length === 0) {
                container.innerHTML = `<div class="col-span-1 md:col-span-2 text-center py-20 glass-card rounded-[2rem] border border-dashed border-gray-300 dark:border-gray-700"><p class="text-gray-500 dark:text-gray-400 text-xl font-bold">هیچ زانکۆیەک نەدۆزرایەوە</p></div>`;
                return;
            }
            ...
            for (let id in unisData) {
                ...
                container.innerHTML += `
                    <div class="glass-card rounded-[2.5rem] shadow-sm hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 p-8 md:p-10 flex flex-col hover:-translate-y-2 relative overflow-hidden group">
