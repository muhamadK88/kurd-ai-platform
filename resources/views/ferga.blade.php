...
<body class="bg-gray-50 text-gray-900 dark:bg-[#0a0f1c] dark:text-white min-h-screen transition-colors duration-300" style="display: none;">
        ...
        <div class="admin-only hidden relative z-10 mt-20 w-full max-w-5xl mx-auto glass-card p-8 rounded-3xl shadow-xl border-t-4 border-purple-600">
            ...
            <form id="form-lang" class="admin-form space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div><label class="block font-bold mb-2">پاشگری زمان (بۆ نموونە: py, php, cpp)</label><input type="text" id="lang_ext" required placeholder="php" class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 font-mono" dir="ltr"></div>
            ...
            <form id="form-lesson" class="admin-form space-y-4 hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div><label class="block font-bold mb-2">زمان</label><select id="lesson_lang_select" required class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700"></select></div>
                    <div><label class="block font-bold mb-2">ئاست (سۆرانی)</label><input type="text" id="lesson_level_so" required class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700"></div>
                    <div><label class="block font-bold mb-2">ئاست (بادینی)</label><input type="text" id="lesson_level_ba" required class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700"></div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                    ...
                    <div><label class="block font-bold mb-2 text-green-600">وەڵامی چاوەڕوانکراو (Expected Output Text)</label><input type="text" id="lesson_expected_output" placeholder="هەولێر" class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 font-mono"></div>
                </div>
                ...
                <div><label class="block font-bold mb-2 mt-4 text-blue-600">ئەنجامی کۆدی نموونە (Example Output)</label><input type="text" id="lesson_example_output" placeholder="hello world" class="w-full p-3 rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 font-mono"></div>
    ...
    <div id="learning-view" class="hidden flex flex-col md:flex-row min-h-[calc(100vh-76px)] relative bg-gray-50 dark:bg-[#0a0f1c]">
        ...
        <main class="flex-1 p-6 md:p-12 overflow-y-auto h-[calc(100vh-76px)] relative z-10 flex flex-col">
            <div class="max-w-4xl mx-auto w-full flex-1 flex flex-col pt-10 md:pt-0">
                ...
                <!-- HTML رێندەرکراو بەهۆی Quill وە -->
                ...
                <div id="challenge-container" class="hidden mb-10 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/15 dark:to-indigo-900/15 border-2 border-purple-300 dark:border-purple-700/50 rounded-2xl p-6 relative overflow-hidden shadow-[0_4px_24px_rgba(147,51,234,0.08)]">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium lang-str" data-so="کۆدەکە لە خوارەوە بنووسە و پشکنینی بکە" data-ba="کۆدەکە لە خوارەوە بنووسە و پشکنینی بکە">کۆدەکە لە خوارەوە بنووسە و پشکنینی بکە</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 flex justify-end">
                        <button onclick="openTryItYourself()" class="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-2.5 rounded-xl font-bold hover:shadow-lg hover:shadow-purple-500/30 hover:-translate-y-0.5 transition-all text-sm">
                            ...
                            کردنەوەی سەکۆی کۆدکردن
                        </button>
                    </div>
                </div>

                <div class="mt-auto pt-8 border-t border-gray-200 dark:border-gray-800 flex justify-between items-center">
                    <button id="btn-prev" class="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 px-6 py-3 rounded-xl font-bold hover:bg-gray-200 transition">&laquo; پێشوو</button>
                    <!-- ئەم دوگمەیە شێوازەکەی دەگۆڕێت بەپێی ئەوەی مەشق هەیە یان نا -->
                ...
                <div class="w-full md:w-1/2 flex flex-col border-b md:border-b-0 md:border-l border-[#333]">
                    <div class="bg-[#2d2d2d] px-4 py-3 flex justify-between items-center">
                        ...
                        <div class="flex gap-2">
                            <button onclick="runCode()" class="bg-gray-700 hover:bg-gray-600 text-white px-5 py-2 rounded-lg font-bold text-sm shadow flex items-center gap-2 transition-all">
                                Run
                            </button>
                            <!-- دوگمەی پشکنینی مەشق ئەگەر هەبوو -->
                            <button id="btn-submit-challenge" onclick="verifyChallenge()" class="hidden bg-purple-600 hover:bg-purple-500 text-white px-6 py-2 rounded-lg font-bold text-sm shadow flex items-center gap-2 transition-all hover:scale-105">
    ...
    <div id="quiz-modal" class="fixed inset-0 bg-gray-900/80 backdrop-blur-md z-[120] hidden flex-col items-center justify-center p-4">
        <div class="bg-white dark:bg-[#111827] rounded-[2rem] shadow-2xl w-full max-w-2xl p-8 relative overflow-hidden border border-gray-100 dark:border-gray-800">
            ...
            <div id="quiz-result" class="hidden text-center py-10">
                ...
                <button onclick="finishQuizAndContinue()" class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg w-full transition-all hover:-translate-y-1">بڕۆ بۆ وانەی داهاتوو</button>
            </div>
    ...
    <script type="module">
        ...
        // Guess file extension from language name when ext field is missing in Firebase
        ...
        // --- COMPILER LOGIC (Native + server-side execution) ---
        ...
        async function runPythonCode() {
            const out = document.getElementById('code-output');
            const code = document.getElementById('user-code').value;
            out.innerText = "سەرقاڵی کارپێکردن..."; out.classList.add("animate-pulse");
            try {
                await initPyodide();
                pyodide.runPython("import sys\nfrom io import StringIO\nsys.stdout = StringIO()");
                await pyodide.runPythonAsync(code);
                latestCompilerOutput = pyodide.runPython("sys.stdout.getvalue()");
                out.innerText = latestCompilerOutput || "(بێ دەرکەوتن)";
            } catch (err) {
                latestCompilerOutput = ""; out.innerText = "هەڵە:\n" + err;
            }
            out.classList.remove("animate-pulse");
        }
        ...
        // --- Server-side PHP execution (via Laravel backend) ---
        async function runPhpCode() {
            const out = document.getElementById('code-output');
            const code = document.getElementById('user-code').value;
            out.innerText = "سەرقاڵی کارپێکردنی PHP..."; out.classList.add("animate-pulse");
            try {
                ...
                if (data.code && data.code !== 0 && !latestCompilerOutput) {
                    out.innerText = "هەڵە لە جێبەجێکردندا\n" + (data.output || "");
                } else {
                    out.innerText = latestCompilerOutput || "(بێ دەرکەوتن)";
                }
            } catch (err) {
                latestCompilerOutput = ""; out.innerText = "هەڵە لە پەیوەندیکردن بە ڕاژەکار:\n" + err;
            }
            out.classList.remove("animate-pulse");
        }

        // --- Server-side execution for other languages (JS, Java, Ruby, etc.) ---
        async function runServerCode(languageExt) {
            const out = document.getElementById('code-output');
            const code = document.getElementById('user-code').value;
            out.innerText = "سەرقاڵی کارپێکردنی کۆدەکە..."; out.classList.add("animate-pulse");
            try {
        ...
        window.verifyChallenge = async function() {
            ...
            btn.innerHTML = '<span class="animate-pulse">سەرقاڵی پشکنین...</span>';
            
            await window.runCode(); // ڕەنکردنی کۆدەکە سەرەتا
            
            const expected = lesson.expected_output ? lesson.expected_output.trim() : "";
            const actual = latestCompilerOutput ? latestCompilerOutput.trim() : "";

            if(actual === expected) {
                btn.innerHTML = "ئافەرین! وەڵامەکە ڕاستە ✓";
                btn.classList.replace('bg-purple-600', 'bg-green-600');
                
                if(!completedLessons.includes(lesson.id)) {
                    completedLessons.push(lesson.id);
                    triggerConfetti();
                    addXP(50); // Big reward for writing code
                ...
                btn.innerHTML = "هەڵەیە، دووبارە تاقیبکەرەوە";
                btn.classList.replace('bg-purple-600', 'bg-red-600');
                setTimeout(() => {
                    btn.innerHTML = '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> پشکنینی مەشق';
        ...
        function renderLanguagesGrid() {
            ...
            for (let id in languagesData) {
                ...
                grid.innerHTML += `
                    <div onclick="openLanguage('${id}')" class="glass-card rounded-[2rem] shadow-sm hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 cursor-pointer flex flex-col items-center text-center p-10 group hover:-translate-y-2">
        ...
        window.openLanguage = function(langId, forcedIndex = null) {
            ...
            // Update Compiler Label — use ext from Firebase, fallback to name detection
        ...
        window.loadLesson = function(index) {
            ...
            if (!isCompleted) {
                btnAction.innerHTML = "تەواوکردنی وانە ✓";
                ...
                btnAction.innerHTML = isLast ? "کۆتایی زمانەکە" : "وانەی داهاتوو &raquo;";
        ...
        window.selectQuizOption = function(idx) {
            ...
            const nextBtn = document.getElementById('btn-next-question');
            nextBtn.disabled = false; nextBtn.className = "bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-2xl font-bold shadow-lg cursor-pointer";
        };
        ...
        function showQuizResult() {
            ...
            document.getElementById('quiz-score-text').innerText = `تۆ وەڵامی ${activeQuizScore} پرسیارت بە دروستی دایەوە (${percent}%)`;
        ...
        window.goBackToHome = function() { document.getElementById('learning-view').classList.add('hidden'); document.getElementById('learning-view').classList.remove('flex'); document.getElementById('home-view').classList.remove('hidden'); };
        ...
        function updateAdminSelects() {
            ...
            for (let id in lessonsData) qSelect.innerHTML += `<option value="${id}">${lessonsData[id].title_so || lessonsData[id].title}</option>`;
        }
        ...
        document.getElementById('form-lang').addEventListener('submit', async (e) => {
            ...
            const data = { 
                ...
                ext: document.getElementById('lang_ext').value.replace('.',''), // Save the extension
        ...
        window.renderManageList = function() {
            ...
            for(let id in dataObj) {
                const item = dataObj[id]; let title = '';
                ...
                listObj.innerHTML += `<div class="flex justify-between p-4 bg-white dark:bg-gray-800 rounded mb-2"><span>${title}</span><div class="flex gap-2"><button onclick="editItem('${cat}','${id}')" class="text-blue-500 font-bold">دەستکاری</button><button onclick="deleteItem('${cat}','${id}')" class="text-red-500 font-bold">سڕینەوە</button></div></div>`;
            }
        };

        window.deleteItem = async function(cat, id) { if(confirm('سڕینەوە؟')) { await remove(dbRef(db, (cat === 'langs' ? 'ferga_languages' : (cat === 'lessons' ? 'ferga_lessons' : 'ferga_quizzes')) + '/' + id)); } };
        ...
        window.editItem = function(cat, id) {
            if(cat === 'langs') {
                ...
                ['lesson_level_so','lesson_level_ba','lesson_title_so','lesson_title_ba','lesson_code','lesson_expected_output','lesson_example_output'].forEach(k => { 
                    const elem = document.getElementById(k);
                    if(elem) elem.value = d[k.replace('lesson_','')] || d[k.replace('lesson_','').replace('_so','')] || ''; 
                });
                // چاککردنی کلیلەکانی مەشق (challenge_desc_so/ba لە Firebase)
