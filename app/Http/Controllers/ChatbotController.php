...
class ChatbotController extends Controller
{
    ...
    {
        $project = dirname(__DIR__, 2) . '/storage/app/ai';
        if (is_dir($project)) {
            return $project;
        }
    ...
    private function systemPrompt(string $lang, string $mode): string
    {
        $base = $lang === 'ba'
            ? 'تۆ یاریدەدەری ژیری دەستکردی پلاتفۆرمی کورد ئەی ئای (Kurd AI) ی ب شێوەزاری بادینی. '
                ...
                . 'ئەگەر لە تە پرسا کێ تە دروست کریە، بەرسڤ بدە: "ئەز ژ لایێ تیما کورد ئەی ئای (Kurd AI) ڤە هاتیمە چێکرن." قەت ناڤێن ڕاژەکاران، کۆمپانیان یان وردەکاریێن تەکنیکی (وەک InferX یان OpenRouter) مەبێژە. '
            ...
            : 'تۆ یاریدەدەری ژیری دەستکردی پلاتفۆرمی کورد ئەی ئای (Kurd AI) ی. '
                ...
                . 'ئەگەر لێت پرسی کێ دروستی کردوویت، وەڵام بدەرەوە: "من لەلایەن تیمی کورد ئەی ئای (Kurd AI) وە دروستکراوم." هەرگیز ناوی ڕاژەکارەکان، کۆمپانیاکان یان وردەکارییە تەکنیکییەکان (وەک InferX یان OpenRouter) مەڵێ. '
